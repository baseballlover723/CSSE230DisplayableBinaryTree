...
public class EditTreeMilestone1Test {
	...
	public void testSingleLeftRotationSecondLevel() {
		...
		t2.add('d');
		assertEquals("[d0=]", t2.toDebugString());
		t2.add('a', 0);
		assertEquals("[d1/, a0=]", t2.toDebugString());
		t2.add('e'); // Two full levels
		assertEquals("[d1=, a0=, e0=]", t2.toDebugString());
		t2.add('b', 1);
		assertEquals("[d2/, a0\\, b0=, e0=]", t2.toDebugString());
	...
	public void testSingleRightRotationFirstLevel() {
		EditTree t = new EditTree();
		t.add('c');
		assertEquals("[c0=]", t.toDebugString());
		t.add('b', 0);
		assertEquals("[c1/, b0=]", t.toDebugString());
	...
	public void testDoubleLeftRotationSecondLevel() {
		...
		t1.add('e');
		assertEquals("[b1\\, a0=, c0\\, e0=]", t1.toDebugString());
	...
	public void testDoubleRightRotationTwoLevelFromFirstLevel() {
		...
		t1.add('g');
		assertEquals("[g0=]", t1.toDebugString());
		t1.add('e', 0);
		assertEquals("[g1/, e0=]", t1.toDebugString());
		t1.add('i');
		assertEquals("[g1=, e0=, i0=]", t1.toDebugString());
		t1.add('b', 0);
		assertEquals("[g2/, e1/, b0=, i0=]", t1.toDebugString());
		t1.add('f', 2);
		assertEquals("[g3/, e1=, b0=, f0=, i0=]", t1.toDebugString());
		t1.add('h', 4);
		assertEquals("[g3=, e1=, b0=, f0=, i1/, h0=]", t1.toDebugString());
		t1.add('j'); // Three full levels
		assertEquals("[g3=, e1=, b0=, f0=, i1=, h0=, j0=]", t1.toDebugString());
		
		t1.add('a', 0);
		assertEquals("[g4/, e2/, b1/, a0=, f0=, i1=, h0=, j0=]", t1.toDebugString());
		t1.add('c', 2);
		assertEquals("[g5/, e3/, b1=, a0=, c0=, f0=, i1=, h0=, j0=]", t1.toDebugString());
		t1.add('d', 3); // Rotation happens here
	...
	public void testGetThreeLevelJagged() {
		...
		assertEquals("[c2/, b1/, a0=, d0=]", t1.toDebugString());
	...
	public void testManyRotations() {
		EditTree t = new EditTree();
		t.add('J');
		assertEquals("[J0=]", t.toDebugString());
		t.add('T');
		assertEquals("[J0\\, T0=]", t.toDebugString());
		t.add('O', 1); //should do a double rotation left
		assertEquals(2, t.totalRotationCount());
		t.add('L', 1);
		t.add('N', 2);
		...
		t.add('q');
		t.add('r');
		assertEquals(13, t.totalRotationCount()); //failing here
